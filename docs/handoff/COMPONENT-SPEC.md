...
| **LibrarySection**    | `features/settings/LibrarySection`        | ActionRow ×2                                                                                          | `{ onAdd, onImport }` — the Settings hub's **Library** group: the `＋ Add a movie` and `⇪ Import from spreadsheet` rows, each an `ActionRow` `{ glyph, label, desc, onClick }` drawn as `page.SettingsPage` draws them. The `⬇ Export to CSV` row arrives with the export initiative; a row whose destination does not exist is not drawn.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
