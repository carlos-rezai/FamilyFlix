...
/**
 * Every field the form collects. Title and Year are all it holds today; the
 * remaining metadata fields, the genre selection, the rating and the three file
 * slots join it as their slices land, and this stays the one shape the form, its
 * hook and its wire call agree on.
 */
